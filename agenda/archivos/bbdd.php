...
try {
    ...
    //creamos un usuario con contraseña en la bdd
    ...
    //creamos la base de datos y las tablas con 10 datos
  ...
  //creamos usuario con contraseña cifrada
   ...
   echo "<div><br>Si ya tienes la base de datos pulsa <a href='../archivos/login.php'>aquí</a></div>";
